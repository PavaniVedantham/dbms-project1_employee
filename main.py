...
class Empdepartment:
    def __init__(self, root):
        self.root = Tk()
        self.root.title('Employees Form')
        self.root.config(bg='#E6E6FA')
        self.root.geometry('1000x700')
        tit = Label(self.root, text="Employee Management", bg="#E6E6FA", font=("bold", '18'))
        tit.pack()
        crud = Label(self.root, text="CRUD Operations", bg="#E6E6FA", font=("Cambria", '18'))
        crud.place(x=400, y=30)
        dis_tables = Label(self.root, text="Display Tables", bg="#E6E6FA", font=("Cambria", '18'))
        dis_tables.place(x=750, y=30)

        F2 = Frame(self.root, bg="#FFA07A")
        F2.place(x=720, y=60, width=250, height=400)

        ## middle frame
        F1 = Frame(self.root, bg="#98FB98")
        F1.place(x=380, y=60, width=250, height=400)

        ## right frame
        F2 = Frame(self.root, bg="#AFEEEE")
        F2.place(x=720, y=60, width=250, height=400)

        attributes = Label(self.root, text="Attributes", bg='#E6E6FA', font=("Cambria", '20'))
        ...
        insert_buton = Button(self.root, text="INSERT", bg="skyblue", font=("bold italic", '12'), height=2, width=7,
                              command=self.insert)
        insert_buton.place(x=480, y=90)

        update_button = Button(self.root, text="UPDATE", bg="skyblue", font=("bold italic", '12'), height=2, width=10,
                               command=self.update)
        update_button.place(x=480, y=180)

        retrieve_button = Button(self.root, text="RETRIEVE", bg="skyblue", font=("bold italic", '12'), height=2, width=10,
                                 command=self.retrieve)
        retrieve_button.place(x=475, y=270)

        delete_button = Button(self.root, text="DELETE", bg="skyblue", font=("bold italic", '12'), height=2, width=10,
                               command=self.delete)
